...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar da Fernanda" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Lucas 2B_</p>
        <h1>Eu sou estudante do Landia</h1>
        <p>Sou aprendiz de eletricista e mecanico automotivo, e futuramente quero aprender a programar. Veja os projetos
            que já desenvolvi!</p>
